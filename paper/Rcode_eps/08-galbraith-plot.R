...
setEPS()
postscript(file = "paper/figures_eps/08-galbraith-plot-naive.eps", width = 5/.70, height = 5)
ggplot_radial(dat,
...
setEPS()
# postscript(file = "paper/figures_eps/08-galbraith-plot.eps", width = 5/.7, height = 5)
ggplot_radial2(dat,
              covari.sel = c(4, 5, 6, 7),
              trt.sel = 3,
              resp.sel = c(1, 2),
