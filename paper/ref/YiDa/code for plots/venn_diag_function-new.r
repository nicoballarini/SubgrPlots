...
#' of the union of all the considered subgroups or not. In addition, this function only works up to 5 sets and does not run an area-proport-
#' -ional algorithms for displaying two or three set. In addition, the function uses log odd ratio and log hazard ratio for displaying
...
#' @export
vd_new <- function(dat, covari.sel, cat.sel, trt.sel, resp.sel, outcome.type, outside.area=FALSE, range.strip=c(-6, 6), n.brk=13,
