#' Interaction plot for subgroup effect
#'
#'
...
#' @export
interactionplt <- function(dat, covari.sel, trt.sel, resp.sel, outcome.type, add.aux.line = FALSE,  font.size = c(15, 10, 0.5), title = NULL, lab.y = NULL)
{
